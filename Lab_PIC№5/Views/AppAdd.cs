...
namespace Lab_PIC_5.Views
{
    public partial class AppAdd : Form
    {
        ...
        {
            var app = new App(date.Text, Convert.ToString(AppRepository.Applicatiions.Count + 1), loc.Text, territory.Text, animalHabbiat.Text, urgency.Text, descrip.Text, categoryApp.Text);
